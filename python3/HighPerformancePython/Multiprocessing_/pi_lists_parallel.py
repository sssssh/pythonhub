...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--nbr_samples_in_total', type=int, default=False,
        help='Number of samples in total e.g. 100000000')
    parser.add_argument(
        '--processes', action='store_true', default=False,
        help='True if using Processes, absent (False) for Thread')
    ...
    print("Making {} samples per {} woker".format(nbr_samples_per_worker,
                                                  nbr_parallel_blocks))
