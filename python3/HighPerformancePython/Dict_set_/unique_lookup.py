...
def list_unique_names(phonebook):
    ...
    for name, phonenumber in phonebook:
        ...
        for unique in unique_nmaes:
            if unique == first_name:
                break
        else:
            unique_nmaes.append(first_name)
    return len(unique_nmaes)
...
if __name__ == "__main__":
    ...
    setup = "from __main__ import (large_phonebook," \
            "set_unique_names, list_unique_names)"
    iterations = 50
    large_phonebook = [
